# Metorial + TogetherAI (TypeScript) Example

This example shows how to use the [Metorial SDK](https://www.npmjs.com/package/metorial) with [TogetherAI](https://together.ai/) in a TypeScript project, including OAuth-enabled servers.
