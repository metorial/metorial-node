...
export type DashboardInstanceIdentityDelegationRequestsApproveOutput = {
...
export let mapDashboardInstanceIdentityDelegationRequestsApproveOutput =
  mtMap.object<DashboardInstanceIdentityDelegationRequestsApproveOutput>({
...
export type DashboardInstanceIdentityDelegationRequestsApproveQuery = {
  allowDeleted?: boolean | undefined;
};

export let mapDashboardInstanceIdentityDelegationRequestsApproveQuery =
  mtMap.object<DashboardInstanceIdentityDelegationRequestsApproveQuery>({
