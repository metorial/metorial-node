...
export type DashboardInstanceIdentityDelegationRequestsGetOutput = {
...
export let mapDashboardInstanceIdentityDelegationRequestsGetOutput =
  mtMap.object<DashboardInstanceIdentityDelegationRequestsGetOutput>({
...
export type DashboardInstanceIdentityDelegationRequestsGetQuery = {
  allowDeleted?: boolean | undefined;
};

export let mapDashboardInstanceIdentityDelegationRequestsGetQuery =
  mtMap.object<DashboardInstanceIdentityDelegationRequestsGetQuery>({
