...
export type DashboardInstanceIdentityDelegationRequestsListOutput = {
  items: {
...
export let mapDashboardInstanceIdentityDelegationRequestsListOutput =
  mtMap.object<DashboardInstanceIdentityDelegationRequestsListOutput>({
...
export type DashboardInstanceIdentityDelegationRequestsListQuery = {
...
export let mapDashboardInstanceIdentityDelegationRequestsListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
