...
export type DashboardInstanceIdentityDelegationsRevokeOutput = {
...
export let mapDashboardInstanceIdentityDelegationsRevokeOutput =
  mtMap.object<DashboardInstanceIdentityDelegationsRevokeOutput>({
