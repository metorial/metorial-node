...
export type DashboardInstanceIdentityDelegationsGetOutput = {
...
export let mapDashboardInstanceIdentityDelegationsGetOutput =
  mtMap.object<DashboardInstanceIdentityDelegationsGetOutput>({
