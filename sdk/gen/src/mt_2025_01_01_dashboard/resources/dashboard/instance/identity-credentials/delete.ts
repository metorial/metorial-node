...
export type DashboardInstanceIdentityCredentialsDeleteOutput = {
...
export let mapDashboardInstanceIdentityCredentialsDeleteOutput =
  mtMap.object<DashboardInstanceIdentityCredentialsDeleteOutput>({
