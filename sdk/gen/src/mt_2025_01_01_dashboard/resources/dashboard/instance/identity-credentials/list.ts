...
export type DashboardInstanceIdentityCredentialsListOutput = {
  items: {
...
export let mapDashboardInstanceIdentityCredentialsListOutput =
  mtMap.object<DashboardInstanceIdentityCredentialsListOutput>({
...
export type DashboardInstanceIdentityCredentialsListQuery = {
...
export let mapDashboardInstanceIdentityCredentialsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
