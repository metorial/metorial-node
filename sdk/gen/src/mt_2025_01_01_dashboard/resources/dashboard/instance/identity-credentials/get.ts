...
export type DashboardInstanceIdentityCredentialsGetOutput = {
...
export let mapDashboardInstanceIdentityCredentialsGetOutput =
  mtMap.object<DashboardInstanceIdentityCredentialsGetOutput>({
