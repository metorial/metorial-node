...
export type DashboardInstanceIdentityCredentialsUpdateOutput = {
...
export let mapDashboardInstanceIdentityCredentialsUpdateOutput =
  mtMap.object<DashboardInstanceIdentityCredentialsUpdateOutput>({
...
export type DashboardInstanceIdentityCredentialsUpdateBody = {
  delegationConfigId: string;
};

export let mapDashboardInstanceIdentityCredentialsUpdateBody =
  mtMap.object<DashboardInstanceIdentityCredentialsUpdateBody>({
    delegationConfigId: mtMap.objectField(
      'delegation_config_id',
      mtMap.passthrough()
    )
