...
export type DashboardInstanceIdentityDelegationConfigsDeleteOutput = {
...
export let mapDashboardInstanceIdentityDelegationConfigsDeleteOutput =
  mtMap.object<DashboardInstanceIdentityDelegationConfigsDeleteOutput>({
