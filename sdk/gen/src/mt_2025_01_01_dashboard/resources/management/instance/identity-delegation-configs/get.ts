...
export type ManagementInstanceIdentityDelegationConfigsGetOutput = {
...
export let mapManagementInstanceIdentityDelegationConfigsGetOutput =
  mtMap.object<ManagementInstanceIdentityDelegationConfigsGetOutput>({
