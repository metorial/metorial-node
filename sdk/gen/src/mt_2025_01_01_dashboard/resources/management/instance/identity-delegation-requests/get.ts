...
export type ManagementInstanceIdentityDelegationRequestsGetOutput = {
...
export let mapManagementInstanceIdentityDelegationRequestsGetOutput =
  mtMap.object<ManagementInstanceIdentityDelegationRequestsGetOutput>({
...
export type ManagementInstanceIdentityDelegationRequestsGetQuery = {
  allowDeleted?: boolean | undefined;
};

export let mapManagementInstanceIdentityDelegationRequestsGetQuery =
  mtMap.object<ManagementInstanceIdentityDelegationRequestsGetQuery>({
