...
export type ManagementInstanceIdentityDelegationRequestsListOutput = {
  items: {
...
export let mapManagementInstanceIdentityDelegationRequestsListOutput =
  mtMap.object<ManagementInstanceIdentityDelegationRequestsListOutput>({
...
export type ManagementInstanceIdentityDelegationRequestsListQuery = {
...
export let mapManagementInstanceIdentityDelegationRequestsListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
