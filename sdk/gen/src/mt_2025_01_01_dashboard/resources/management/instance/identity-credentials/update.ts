...
export type ManagementInstanceIdentityCredentialsUpdateOutput = {
...
export let mapManagementInstanceIdentityCredentialsUpdateOutput =
  mtMap.object<ManagementInstanceIdentityCredentialsUpdateOutput>({
...
export type ManagementInstanceIdentityCredentialsUpdateBody = {
  delegationConfigId: string;
};

export let mapManagementInstanceIdentityCredentialsUpdateBody =
  mtMap.object<ManagementInstanceIdentityCredentialsUpdateBody>({
    delegationConfigId: mtMap.objectField(
      'delegation_config_id',
      mtMap.passthrough()
    )
