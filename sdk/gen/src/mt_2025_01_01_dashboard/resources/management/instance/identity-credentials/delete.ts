...
export type ManagementInstanceIdentityCredentialsDeleteOutput = {
...
export let mapManagementInstanceIdentityCredentialsDeleteOutput =
  mtMap.object<ManagementInstanceIdentityCredentialsDeleteOutput>({
