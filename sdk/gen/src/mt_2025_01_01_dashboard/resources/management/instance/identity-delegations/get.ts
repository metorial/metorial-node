...
export type ManagementInstanceIdentityDelegationsGetOutput = {
...
export let mapManagementInstanceIdentityDelegationsGetOutput =
  mtMap.object<ManagementInstanceIdentityDelegationsGetOutput>({
