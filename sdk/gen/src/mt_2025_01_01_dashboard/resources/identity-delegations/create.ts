...
export type IdentityDelegationsCreateOutput = {
...
export let mapIdentityDelegationsCreateOutput =
  mtMap.object<IdentityDelegationsCreateOutput>({
...
export type IdentityDelegationsCreateBody = {
  identityId: string;
...
export let mapIdentityDelegationsCreateBody =
  mtMap.object<IdentityDelegationsCreateBody>({
    identityId: mtMap.objectField('identity_id', mtMap.passthrough()),
