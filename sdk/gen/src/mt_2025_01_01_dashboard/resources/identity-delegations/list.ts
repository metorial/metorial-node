...
export type IdentityDelegationsListOutput = {
  items: {
...
export let mapIdentityDelegationsListOutput =
  mtMap.object<IdentityDelegationsListOutput>({
...
export type IdentityDelegationsListQuery = {
...
export let mapIdentityDelegationsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
