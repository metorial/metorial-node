...
export type IdentityDelegationRequestsListOutput = {
  items: {
...
export let mapIdentityDelegationRequestsListOutput =
  mtMap.object<IdentityDelegationRequestsListOutput>({
...
export type IdentityDelegationRequestsListQuery = {
...
export let mapIdentityDelegationRequestsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
