...
export type IdentityDelegationRequestsDenyOutput = {
...
export let mapIdentityDelegationRequestsDenyOutput =
  mtMap.object<IdentityDelegationRequestsDenyOutput>({
...
export type IdentityDelegationRequestsDenyQuery = {
  allowDeleted?: boolean | undefined;
};

export let mapIdentityDelegationRequestsDenyQuery =
  mtMap.object<IdentityDelegationRequestsDenyQuery>({
