...
export class MetorialDashboardInstancePortalsConsumerProfilesEndpoint {
  ...
  list(
    ...
    let request = {
      ...
      query: query
        ? mapDashboardInstancePortalsConsumerProfilesListQuery.transformTo(query)
        : undefined,
      ...(opts?.headers ? { headers: opts.headers } : {})
    } as any;

    return this._get(request).transform(mapDashboardInstancePortalsConsumerProfilesListOutput);
  }
  ...
  get(
    ...
    return this._get(request).transform(mapDashboardInstancePortalsConsumerProfilesGetOutput);
  }
  ...
  assignGroups(
    ...
    let request = {
      path,
      body: mapDashboardInstancePortalsConsumerProfilesAssignGroupsBody.transformTo(body),
  ...
  unassignGroups(
    ...
    let request = {
      path,
      body: mapDashboardInstancePortalsConsumerProfilesUnassignGroupsBody.transformTo(body),
