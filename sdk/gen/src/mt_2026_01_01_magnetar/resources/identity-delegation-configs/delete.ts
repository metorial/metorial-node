...
export type IdentityDelegationConfigsDeleteOutput = {
...
export let mapIdentityDelegationConfigsDeleteOutput =
  mtMap.object<IdentityDelegationConfigsDeleteOutput>({
