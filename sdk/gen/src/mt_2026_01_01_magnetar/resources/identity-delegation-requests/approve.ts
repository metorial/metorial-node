...
export type IdentityDelegationRequestsApproveOutput = {
...
export let mapIdentityDelegationRequestsApproveOutput =
  mtMap.object<IdentityDelegationRequestsApproveOutput>({
...
export type IdentityDelegationRequestsApproveQuery = {
  allowDeleted?: boolean | undefined;
};

export let mapIdentityDelegationRequestsApproveQuery =
  mtMap.object<IdentityDelegationRequestsApproveQuery>({
