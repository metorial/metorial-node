...
export type IdentityDelegationRequestsGetOutput = {
...
export let mapIdentityDelegationRequestsGetOutput =
  mtMap.object<IdentityDelegationRequestsGetOutput>({
...
export type IdentityDelegationRequestsGetQuery = {
  allowDeleted?: boolean | undefined;
};

export let mapIdentityDelegationRequestsGetQuery =
  mtMap.object<IdentityDelegationRequestsGetQuery>({
