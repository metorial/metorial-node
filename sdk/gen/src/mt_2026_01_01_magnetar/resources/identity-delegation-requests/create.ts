...
export type IdentityDelegationRequestsCreateOutput = {
...
export let mapIdentityDelegationRequestsCreateOutput =
  mtMap.object<IdentityDelegationRequestsCreateOutput>({
...
export type IdentityDelegationRequestsCreateBody = {
  identityId: string;
...
export let mapIdentityDelegationRequestsCreateBody =
  mtMap.object<IdentityDelegationRequestsCreateBody>({
    identityId: mtMap.objectField('identity_id', mtMap.passthrough()),
