...
export type ManagementInstanceIdentityCredentialsGetOutput = {
...
export let mapManagementInstanceIdentityCredentialsGetOutput =
  mtMap.object<ManagementInstanceIdentityCredentialsGetOutput>({
