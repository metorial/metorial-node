...
export type ManagementInstanceIdentityCredentialsListOutput = {
  items: {
...
export let mapManagementInstanceIdentityCredentialsListOutput =
  mtMap.object<ManagementInstanceIdentityCredentialsListOutput>({
...
export type ManagementInstanceIdentityCredentialsListQuery = {
...
export let mapManagementInstanceIdentityCredentialsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
