...
export type ManagementInstanceIdentityCredentialsCreateOutput = {
...
export let mapManagementInstanceIdentityCredentialsCreateOutput =
  mtMap.object<ManagementInstanceIdentityCredentialsCreateOutput>({
...
export type ManagementInstanceIdentityCredentialsCreateBody = {
  identityId: string;
...
export let mapManagementInstanceIdentityCredentialsCreateBody =
  mtMap.object<ManagementInstanceIdentityCredentialsCreateBody>({
    identityId: mtMap.objectField('identity_id', mtMap.passthrough()),
    deploymentId: mtMap.objectField('deployment_id', mtMap.passthrough()),
    configId: mtMap.objectField('config_id', mtMap.passthrough()),
    authConfigId: mtMap.objectField('auth_config_id', mtMap.passthrough()),
