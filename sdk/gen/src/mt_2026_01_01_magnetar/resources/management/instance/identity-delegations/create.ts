...
export type ManagementInstanceIdentityDelegationsCreateOutput = {
...
export let mapManagementInstanceIdentityDelegationsCreateOutput =
  mtMap.object<ManagementInstanceIdentityDelegationsCreateOutput>({
...
export type ManagementInstanceIdentityDelegationsCreateBody = {
  identityId: string;
...
export let mapManagementInstanceIdentityDelegationsCreateBody =
  mtMap.object<ManagementInstanceIdentityDelegationsCreateBody>({
    identityId: mtMap.objectField('identity_id', mtMap.passthrough()),
