...
export type ManagementInstanceIdentityDelegationsRevokeOutput = {
...
export let mapManagementInstanceIdentityDelegationsRevokeOutput =
  mtMap.object<ManagementInstanceIdentityDelegationsRevokeOutput>({
