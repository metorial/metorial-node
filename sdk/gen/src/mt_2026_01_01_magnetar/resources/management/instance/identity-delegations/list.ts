...
export type ManagementInstanceIdentityDelegationsListOutput = {
  items: {
...
export let mapManagementInstanceIdentityDelegationsListOutput =
  mtMap.object<ManagementInstanceIdentityDelegationsListOutput>({
...
export type ManagementInstanceIdentityDelegationsListQuery = {
...
export let mapManagementInstanceIdentityDelegationsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
