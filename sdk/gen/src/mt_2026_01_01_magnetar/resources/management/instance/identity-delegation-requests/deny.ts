...
export type ManagementInstanceIdentityDelegationRequestsDenyOutput = {
...
export let mapManagementInstanceIdentityDelegationRequestsDenyOutput =
  mtMap.object<ManagementInstanceIdentityDelegationRequestsDenyOutput>({
...
export type ManagementInstanceIdentityDelegationRequestsDenyQuery = {
  allowDeleted?: boolean | undefined;
};

export let mapManagementInstanceIdentityDelegationRequestsDenyQuery =
  mtMap.object<ManagementInstanceIdentityDelegationRequestsDenyQuery>({
