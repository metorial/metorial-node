...
export type ManagementInstanceIdentityDelegationRequestsCreateOutput = {
...
export let mapManagementInstanceIdentityDelegationRequestsCreateOutput =
  mtMap.object<ManagementInstanceIdentityDelegationRequestsCreateOutput>({
...
export type ManagementInstanceIdentityDelegationRequestsCreateBody = {
  identityId: string;
...
export let mapManagementInstanceIdentityDelegationRequestsCreateBody =
  mtMap.object<ManagementInstanceIdentityDelegationRequestsCreateBody>({
    identityId: mtMap.objectField('identity_id', mtMap.passthrough()),
