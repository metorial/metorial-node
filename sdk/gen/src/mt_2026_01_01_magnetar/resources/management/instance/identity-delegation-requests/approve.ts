...
export type ManagementInstanceIdentityDelegationRequestsApproveOutput = {
...
export let mapManagementInstanceIdentityDelegationRequestsApproveOutput =
  mtMap.object<ManagementInstanceIdentityDelegationRequestsApproveOutput>({
...
export type ManagementInstanceIdentityDelegationRequestsApproveQuery = {
  allowDeleted?: boolean | undefined;
};

export let mapManagementInstanceIdentityDelegationRequestsApproveQuery =
  mtMap.object<ManagementInstanceIdentityDelegationRequestsApproveQuery>({
