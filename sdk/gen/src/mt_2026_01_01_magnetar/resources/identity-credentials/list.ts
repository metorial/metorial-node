...
export type IdentityCredentialsListOutput = {
  items: {
...
export let mapIdentityCredentialsListOutput =
  mtMap.object<IdentityCredentialsListOutput>({
...
export type IdentityCredentialsListQuery = {
...
export let mapIdentityCredentialsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
