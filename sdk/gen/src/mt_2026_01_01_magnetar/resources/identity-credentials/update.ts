...
export type IdentityCredentialsUpdateOutput = {
...
export let mapIdentityCredentialsUpdateOutput =
  mtMap.object<IdentityCredentialsUpdateOutput>({
...
export type IdentityCredentialsUpdateBody = { delegationConfigId: string };

export let mapIdentityCredentialsUpdateBody =
  mtMap.object<IdentityCredentialsUpdateBody>({
    delegationConfigId: mtMap.objectField(
      'delegation_config_id',
      mtMap.passthrough()
    )
