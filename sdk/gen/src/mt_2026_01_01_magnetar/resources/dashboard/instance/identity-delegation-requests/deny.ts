...
export type DashboardInstanceIdentityDelegationRequestsDenyOutput = {
...
export let mapDashboardInstanceIdentityDelegationRequestsDenyOutput =
  mtMap.object<DashboardInstanceIdentityDelegationRequestsDenyOutput>({
...
export type DashboardInstanceIdentityDelegationRequestsDenyQuery = {
  allowDeleted?: boolean | undefined;
};

export let mapDashboardInstanceIdentityDelegationRequestsDenyQuery =
  mtMap.object<DashboardInstanceIdentityDelegationRequestsDenyQuery>({
