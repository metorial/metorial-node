...
export type DashboardInstanceIdentityDelegationRequestsCreateOutput = {
...
export let mapDashboardInstanceIdentityDelegationRequestsCreateOutput =
  mtMap.object<DashboardInstanceIdentityDelegationRequestsCreateOutput>({
...
export type DashboardInstanceIdentityDelegationRequestsCreateBody = {
  identityId: string;
...
export let mapDashboardInstanceIdentityDelegationRequestsCreateBody =
  mtMap.object<DashboardInstanceIdentityDelegationRequestsCreateBody>({
    identityId: mtMap.objectField('identity_id', mtMap.passthrough()),
