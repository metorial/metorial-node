...
export type DashboardInstanceIdentityCredentialsCreateOutput = {
...
export let mapDashboardInstanceIdentityCredentialsCreateOutput =
  mtMap.object<DashboardInstanceIdentityCredentialsCreateOutput>({
...
export type DashboardInstanceIdentityCredentialsCreateBody = {
  identityId: string;
...
export let mapDashboardInstanceIdentityCredentialsCreateBody =
  mtMap.object<DashboardInstanceIdentityCredentialsCreateBody>({
    identityId: mtMap.objectField('identity_id', mtMap.passthrough()),
    deploymentId: mtMap.objectField('deployment_id', mtMap.passthrough()),
    configId: mtMap.objectField('config_id', mtMap.passthrough()),
    authConfigId: mtMap.objectField('auth_config_id', mtMap.passthrough()),
