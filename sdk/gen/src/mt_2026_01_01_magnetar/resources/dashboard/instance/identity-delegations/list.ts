...
export type DashboardInstanceIdentityDelegationsListOutput = {
  items: {
...
export let mapDashboardInstanceIdentityDelegationsListOutput =
  mtMap.object<DashboardInstanceIdentityDelegationsListOutput>({
...
export type DashboardInstanceIdentityDelegationsListQuery = {
...
export let mapDashboardInstanceIdentityDelegationsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
