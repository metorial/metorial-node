...
export type DashboardInstanceIdentityDelegationsCreateOutput = {
...
export let mapDashboardInstanceIdentityDelegationsCreateOutput =
  mtMap.object<DashboardInstanceIdentityDelegationsCreateOutput>({
...
export type DashboardInstanceIdentityDelegationsCreateBody = {
  identityId: string;
...
export let mapDashboardInstanceIdentityDelegationsCreateBody =
  mtMap.object<DashboardInstanceIdentityDelegationsCreateBody>({
    identityId: mtMap.objectField('identity_id', mtMap.passthrough()),
