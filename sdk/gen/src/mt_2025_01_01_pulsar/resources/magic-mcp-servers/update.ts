...
export let mapMagicMcpServersUpdateOutput = mtMap.object<MagicMcpServersUpdateOutput>({
...
export let mapMagicMcpServersUpdateBody = mtMap.object<MagicMcpServersUpdateBody>({
  name: mtMap.objectField('name', mtMap.passthrough()),
  description: mtMap.objectField('description', mtMap.passthrough()),
  metadata: mtMap.objectField('metadata', mtMap.passthrough()),
