...
export let mapMagicMcpServersCreateOutput = mtMap.object<MagicMcpServersCreateOutput>({
...
export let mapMagicMcpServersCreateBody = mtMap.union([
  mtMap.unionOption(
    ...
    mtMap.object({
      ...
      access: mtMap.objectField(
        ...
        mtMap.object({
          ipAllowlist: mtMap.objectField(
            'ip_allowlist',
            mtMap.object({
              ipWhitelist: mtMap.objectField('ip_whitelist', mtMap.array(mtMap.passthrough())),
              ipBlacklist: mtMap.objectField('ip_blacklist', mtMap.array(mtMap.passthrough()))
            })
          )
        })
      ),
      ...
      serverVariantId: mtMap.objectField('server_variant_id', mtMap.passthrough()),
      serverId: mtMap.objectField('server_id', mtMap.passthrough()),
      defaultOauthSessionId: mtMap.objectField('default_oauth_session_id', mtMap.passthrough())
    })
  )
]);
