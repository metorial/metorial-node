    ...
    callbacks: mtMap.objectField(
      ...
      mtMap.union([
        mtMap.unionOption(
          ...
          mtMap.object({
            type: mtMap.objectField('type', mtMap.passthrough()),
            callbackIds: mtMap.objectField('callback_ids', mtMap.array(mtMap.passthrough()))
          })
        )
      ])
    ),
...
export let mapCallbacksDestinationsCreateBody = mtMap.object<CallbacksDestinationsCreateBody>({
  name: mtMap.objectField('name', mtMap.passthrough()),
  description: mtMap.objectField('description', mtMap.passthrough()),
  url: mtMap.objectField('url', mtMap.passthrough()),
  callbacks: mtMap.objectField(
    ...
    mtMap.union([
      mtMap.unionOption(
        ...
        mtMap.object({
          type: mtMap.objectField('type', mtMap.passthrough()),
          callbackId: mtMap.objectField('callback_id', mtMap.array(mtMap.passthrough()))
        })
      )
    ])
  )
