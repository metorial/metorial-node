  ...
  mtMap.object<CustomServersListingUpdateOutput>({
    ...
    repository: mtMap.objectField(
      ...
      mtMap.object({
        ...
        openIssuesCount: mtMap.objectField('open_issues_count', mtMap.passthrough()),
        subscriptionCount: mtMap.objectField('subscription_count', mtMap.passthrough()),
        ...
        licenseSpdxId: mtMap.objectField('license_spdx_id', mtMap.passthrough()),
...
export let mapCustomServersListingUpdateBody = mtMap.object<CustomServersListingUpdateBody>({
  status: mtMap.objectField('status', mtMap.passthrough()),
  name: mtMap.objectField('name', mtMap.passthrough()),
  description: mtMap.objectField('description', mtMap.passthrough()),
  readme: mtMap.objectField('readme', mtMap.passthrough()),
