...
export let mapCustomServersVersionsGetOutput = mtMap.object<CustomServersVersionsGetOutput>({
      ...
      oauth: mtMap.objectField(
        ...
        mtMap.union([
          mtMap.unionOption(
            ...
            mtMap.object({
              status: mtMap.objectField('status', mtMap.passthrough()),
              credentialProvider: mtMap.objectField('credential_provider', mtMap.passthrough())
            })
          )
        ])
      ),
