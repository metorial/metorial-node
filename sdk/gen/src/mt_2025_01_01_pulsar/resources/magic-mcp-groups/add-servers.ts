...
export let mapMagicMcpGroupsAddServersOutput = mtMap.object<MagicMcpGroupsAddServersOutput>({
...
export let mapMagicMcpGroupsAddServersBody = mtMap.object<MagicMcpGroupsAddServersBody>({
