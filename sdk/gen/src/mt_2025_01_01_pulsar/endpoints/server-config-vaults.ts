...
export class MetorialServerConfigVaultsEndpoint {
  ...
  list(
    ...
    return this._get(request).transform(mapDashboardInstanceServerConfigVaultsListOutput);
  }
  ...
  get(
    ...
    return this._get(request).transform(mapDashboardInstanceServerConfigVaultsGetOutput);
  }
  ...
  create(
    ...
    return this._post(request).transform(mapDashboardInstanceServerConfigVaultsCreateOutput);
  }
  ...
  update(
    ...
    return this._patch(request).transform(mapDashboardInstanceServerConfigVaultsUpdateOutput);
  }
}
