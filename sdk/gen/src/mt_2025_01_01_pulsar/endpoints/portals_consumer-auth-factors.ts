...
export class MetorialPortalsConsumerAuthFactorsEndpoint {
  ...
  list(
    ...
    let request = {
      ...
      query: query
        ? mapDashboardInstancePortalsConsumerAuthFactorsListQuery.transformTo(query)
        : undefined,
  ...
  create(
    ...
    let request = {
      path,
      body: mapDashboardInstancePortalsConsumerAuthFactorsCreateBody.transformTo(body),
  ...
  update(
    ...
    let request = {
      path,
      body: mapDashboardInstancePortalsConsumerAuthFactorsUpdateBody.transformTo(body),
