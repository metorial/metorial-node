...
export class MetorialManagementInstanceCustomServersDeploymentsEndpoint {
  ...
  list(
    ...
    let request = {
      ...
      query: query
        ? mapDashboardInstanceCustomServersDeploymentsListQuery.transformTo(query)
        : undefined,
  ...
  get(
    ...
    return this._get(request).transform(mapDashboardInstanceCustomServersDeploymentsGetOutput);
  }
}
