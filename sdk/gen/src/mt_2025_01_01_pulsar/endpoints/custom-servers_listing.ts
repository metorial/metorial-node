...
export class MetorialCustomServersListingEndpoint {
  ...
  get(
    ...
    return this._get(request).transform(mapDashboardInstanceCustomServersListingGetOutput);
  }
  ...
  update(
    ...
    let request = {
      path,
      body: mapDashboardInstanceCustomServersListingUpdateBody.transformTo(body),
