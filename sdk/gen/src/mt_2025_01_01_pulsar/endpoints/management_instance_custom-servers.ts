...
export class MetorialManagementInstanceCustomServersEndpoint {
  ...
  list(
    ...
    let request = {
      ...
      query: query ? mapDashboardInstanceCustomServersListQuery.transformTo(query) : undefined,
      ...(opts?.headers ? { headers: opts.headers } : {})
    } as any;

    return this._get(request).transform(mapDashboardInstanceCustomServersListOutput);
  }
  ...
  create(
    ...
    return this._post(request).transform(mapDashboardInstanceCustomServersCreateOutput);
  }
  ...
  update(
    ...
    return this._patch(request).transform(mapDashboardInstanceCustomServersUpdateOutput);
  }
  ...
  delete(
    ...
    return this._delete(request).transform(mapDashboardInstanceCustomServersDeleteOutput);
  }
  ...
  get(
    ...
    return this._get(request).transform(mapDashboardInstanceCustomServersGetOutput);
  }
}
