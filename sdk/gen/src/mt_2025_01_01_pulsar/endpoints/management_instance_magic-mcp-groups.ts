...
export class MetorialManagementInstanceMagicMcpGroupsEndpoint {
  ...
  list(
    ...
    return this._get(request).transform(mapDashboardInstanceMagicMcpGroupsListOutput);
  }
  ...
  get(
    ...
    return this._get(request).transform(mapDashboardInstanceMagicMcpGroupsGetOutput);
  }
  ...
  create(
    ...
    return this._post(request).transform(mapDashboardInstanceMagicMcpGroupsCreateOutput);
  }
  ...
  delete(
    ...
    return this._delete(request).transform(mapDashboardInstanceMagicMcpGroupsDeleteOutput);
  }
  ...
  update(
    ...
    return this._patch(request).transform(mapDashboardInstanceMagicMcpGroupsUpdateOutput);
  }
  ...
  addServers(
    ...
    return this._post(request).transform(mapDashboardInstanceMagicMcpGroupsAddServersOutput);
  }
  ...
  removeServers(
    ...
    let request = {
      path,
      body: mapDashboardInstanceMagicMcpGroupsRemoveServersBody.transformTo(body),
