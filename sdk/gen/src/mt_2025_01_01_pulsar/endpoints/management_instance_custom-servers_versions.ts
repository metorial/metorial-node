...
export class MetorialManagementInstanceCustomServersVersionsEndpoint {
  ...
  list(
    ...
    return this._get(request).transform(mapDashboardInstanceCustomServersVersionsListOutput);
  }
  ...
  create(
    ...
    let request = {
      path,
      body: mapDashboardInstanceCustomServersVersionsCreateBody.transformTo(body),
  ...
  get(
    ...
    return this._get(request).transform(mapDashboardInstanceCustomServersVersionsGetOutput);
  }
}
