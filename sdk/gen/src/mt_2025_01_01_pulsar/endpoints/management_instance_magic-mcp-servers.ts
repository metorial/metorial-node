...
export class MetorialManagementInstanceMagicMcpServersEndpoint {
  ...
  list(
    ...
    return this._get(request).transform(mapDashboardInstanceMagicMcpServersListOutput);
  }
  ...
  get(
    ...
    return this._get(request).transform(mapDashboardInstanceMagicMcpServersGetOutput);
  }
  ...
  create(
    ...
    return this._post(request).transform(mapDashboardInstanceMagicMcpServersCreateOutput);
  }
  ...
  delete(
    ...
    return this._delete(request).transform(mapDashboardInstanceMagicMcpServersDeleteOutput);
  }
  ...
  update(
    ...
    return this._patch(request).transform(mapDashboardInstanceMagicMcpServersUpdateOutput);
  }
}
