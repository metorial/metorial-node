...
export class MetorialDashboardInstanceSsoTenantsEndpoint {
  ...
  list(
    ...
    let request = {
      ...
      query: query ? mapDashboardInstanceSsoTenantsListQuery.transformTo(query) : undefined,
      ...(opts?.headers ? { headers: opts.headers } : {})
    } as any;

    return this._get(request).transform(mapDashboardInstanceSsoTenantsListOutput);
  }
  ...
  get(
    ...
    return this._get(request).transform(mapDashboardInstanceSsoTenantsGetOutput);
  }
  ...
  create(
    ...
    return this._post(request).transform(mapDashboardInstanceSsoTenantsCreateOutput);
  }
  ...
  setup(
    ...
    return this._post(request).transform(mapDashboardInstanceSsoTenantsSetupOutput);
  }
}
