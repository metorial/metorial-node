...
export class MetorialManagementInstanceCallbacksNotificationsEndpoint {
  ...
  list(
    ...
    return this._get(request).transform(mapDashboardInstanceCallbacksNotificationsListOutput);
  }
  ...
  get(
    ...
    return this._get(request).transform(mapDashboardInstanceCallbacksNotificationsGetOutput);
  }
}
