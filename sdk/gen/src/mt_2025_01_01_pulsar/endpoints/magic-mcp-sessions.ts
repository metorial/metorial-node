...
export class MetorialMagicMcpSessionsEndpoint {
  ...
  list(
    ...
    return this._get(request).transform(mapDashboardInstanceMagicMcpSessionsListOutput);
  }
  ...
  get(
    ...
    return this._get(request).transform(mapDashboardInstanceMagicMcpSessionsGetOutput);
  }
}
