...
export class MetorialServersListingsCollectionsEndpoint {
  ...
  list(
    ...
    let request = {
      ...
      query: query ? mapServersListingsCollectionsListQuery.transformTo(query) : undefined,
      ...(opts?.headers ? { headers: opts.headers } : {})
    } as any;

    return this._get(request).transform(mapServersListingsCollectionsListOutput);
  }
