...
export class MetorialDashboardInstanceCallbacksEventsEndpoint {
  ...
  list(
    ...
    return this._get(request).transform(mapDashboardInstanceCallbacksEventsListOutput);
  }
  ...
  get(
    ...
    return this._get(request).transform(mapDashboardInstanceCallbacksEventsGetOutput);
  }
}
