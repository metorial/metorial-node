...
export class MetorialDashboardInstanceSsoTenantsProfilesEndpoint {
  ...
  list(
    ...
    return this._get(request).transform(mapDashboardInstanceSsoTenantsProfilesListOutput);
  }
  ...
  get(
    ...
    return this._get(request).transform(mapDashboardInstanceSsoTenantsProfilesGetOutput);
  }
}
